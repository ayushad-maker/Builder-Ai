...
const BuilderHeader = ({
  ...
  return (
    <header className="h-12 shrink-0 flex items-center justify-between px-3 border-b border-zinc-500 bg-white">
      <div className="flex items-center gap-3">
        <button
          onClick={onBack}
          className="p-1.5 rounded-md text-zinc-400 hover:text-zinc-900 hover:bg-zinc-100 cursor-pointer "
        >
      ...
      <div className="flex items-center gap-1.5">
        ...
        >
          {publishing ? <Loader2Icon size={13} /> : <GlobeIcon size={13} />}{" "}
          Publish
        </button>
