      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-[11px] font-semibold text-zinc-400 uppercase tracking-widest mb-2 mt-3">
                Email Address
              </label>
              <input
                type="email"
          ...
          <p className="text-sm text-zinc-900 mt-8 pt-6 border-t border-zinc-900 font-sans">
            {isLogin ? (
              <>
                New To BuilderAI?{" "}
                <Link
